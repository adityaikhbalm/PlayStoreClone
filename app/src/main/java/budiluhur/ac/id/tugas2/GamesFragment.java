...
public class GamesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if(i == 0) {
                icon.setColorFilter(ContextCompat.getColor(getActivity(), R.color.top2), android.graphics.PorterDuff.Mode.SRC_IN);
                text.setTextColor(ContextCompat.getColor(getActivity(), R.color.top2));
            } else {
