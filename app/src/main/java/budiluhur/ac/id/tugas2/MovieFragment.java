...
public class MovieFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if(i == 0) {
                icon.setColorFilter(ContextCompat.getColor(getActivity(), R.color.top3), android.graphics.PorterDuff.Mode.SRC_IN);
                text.setTextColor(ContextCompat.getColor(getActivity(), R.color.top3));
            } else {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(home2, "Top Selling");
        adapter.addFrag(home3, "New Release");
